...
object PromptCardDefaults {
    const val DEFAULT_FIRST_TURN = """
        The camera pans down. It's your first time in this place. 
        Describe the scene and how the world feels from the character's perspective.
    """

    const val DEFAULT_STACK_INSTRUCTIONS = """
        {
